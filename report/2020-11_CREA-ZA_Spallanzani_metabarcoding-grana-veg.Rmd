...
#old DB, with plants from all over the world
if (FALSE){
...
#hand picked DB with Grana Padano + Italian plants
...
Ecco i dettagli sulla creazione del db up_to_200kb:
    ...
    Ottenuta dal cliente una lista di 910 accessioni da scaricare e da usare come db

    Dopo aver epurate le accessioni duplicate o triplicate siamo scesi a 893 accessioni
    ...
    Sono state poi filtrate 5 sequenze vuote e le 14 sequenze più lunghe di 200kb. Rimangono 873 accessioni.
    La pipeline dell'analisi è la stessa delle volete scorse.
...
Sono stati ulteriormente eliminate le sequenze più lunghe di 10kb per creazione del db up_to_10kb.

La pipeline dell'analisi è la stessa delle volete scorse.

Da una prima occhiata i risultati ottenuti con 10kb e 200kb sono identici. 
