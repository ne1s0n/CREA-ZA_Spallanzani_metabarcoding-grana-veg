...
#example calls
# OTU = build_OTU_table(raw_OTUs, 'clade_phylum') 
# OTU = build_OTU_table(raw_OTUs, 'class') 
# OTU = build_OTU_table(raw_OTUs, 'order') 
# OTU = build_OTU_table(raw_OTUs, 'family') 
# OTU = build_OTU_table(raw_OTUs, 'genus') 
# OTU = build_OTU_table(raw_OTUs, 'species') 
...
**OPEN QUESTION**: how consistent is this with the received results? I can get easily percentages sensibly higher there (85-90% of unassigned).

# Control samples

```{r echo=FALSE, include=TRUE}
OTU_ctrl = build_OTU_table(raw_OTUs, 'domain') 
OTU_ctrl = subset(OTU_ctrl, type == 'ctrl')
```
