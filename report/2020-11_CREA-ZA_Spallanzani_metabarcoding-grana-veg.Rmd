...
```{r, echo=FALSE, include=TRUE}
p = ggplot(subset(alpha_long, alpha == 'Shannon'), aes(x=value, fill=type)) + 
...
p = ggplot(mds_data, aes(x = MDS1, y = MDS2, color = type, label=labs)) + 
   geom_point(size=3) + geom_label() + theme_bw() + 
  theme(legend.position = 'none', axis.text = element_text(color='black')) 
  
#saving the figure
ggsave(filename = paste(sep='', figure_outfolder, 'diversity_beta_area.tiff'), plot = p, device = 'tiff', width = 1800, height = 1575, units = 'px')
...
p = ggplot(subset(mds_data, province!= '-'), aes(x = MDS1, y = MDS2, color = province, shape=province)) +
  scale_shape_manual(values = shapes_prov) + geom_point(size=3) + theme_bw() + 
  theme(axis.text = element_text(color='black'))

#saving the figure
ggsave(filename = paste(sep='', figure_outfolder, 'diversity_beta_provinces.tiff'), plot = p, device = 'tiff', width = 1800, height = 1575, units = 'px')
